...
ENV POSTGRESQL_USER nailgun
ENV POSTGRESQL_PASS nailgun
ENV POSTGRESQL_DB nailgun
ENV POSTGRESQL_USER2 ostf
ENV POSTGRESQL_PASS2 ostf
ENV POSTGRESQL_DB2 ostf
